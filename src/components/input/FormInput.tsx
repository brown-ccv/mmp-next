...
interface FormInputProps extends BaseInputProps {
    match?: "valueMissing" | "typeMismatch" | "patternMismatch" | "tooLong" | "tooShort" | "rangeUnderflow" | "rangeOverflow" | "stepMismatch" | "badInput" | ((value: string, formData: FormData) => boolean);
    errorMessage?: string;
}
